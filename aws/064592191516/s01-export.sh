...
terraformer import aws --profile=064592191516 --resources=medialive
terraformer import aws --profile=064592191516 --resources=mq
...
terraformer import aws --profile=064592191516 --resources=vpc_endpoint
