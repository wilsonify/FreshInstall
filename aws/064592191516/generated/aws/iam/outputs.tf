...
output "aws_iam_policy_tfer--AmazonSageMakerServiceCatalogProductsUseRole-20230916T105295_id" {
  value = "${aws_iam_policy.tfer--AmazonSageMakerServiceCatalogProductsUseRole-20230916T105295.id}"
}

output "aws_iam_policy_tfer--LambdaCloudWatchLogsPolicy_id" {
...
output "aws_iam_policy_tfer--StepFunctionsStartExecutionManagementScopedAccessPolicy-03cdcf15-3121-48e4-ba91-a84d2c0ebe62_id" {
  value = "${aws_iam_policy.tfer--StepFunctionsStartExecutionManagementScopedAccessPolicy-03cdcf15-3121-48e4-ba91-a84d2c0ebe62.id}"
}

output "aws_iam_policy_tfer--XRayAccessPolicy-169f2389-3183-4b01-be7f-2234ce0879ae_id" {
  value = "${aws_iam_policy.tfer--XRayAccessPolicy-169f2389-3183-4b01-be7f-2234ce0879ae.id}"
}

output "aws_iam_policy_tfer--custom-resources-lambda-policy_id" {
...
output "aws_iam_role_policy_attachment_tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMaker-ExecutionPolicy-20230916T105234_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMaker-ExecutionPolicy-20230916T105234.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMakerCanvasAIServicesAccess_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMakerCanvasAIServicesAccess.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMakerCanvasFullAccess_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMakerCanvasFullAccess.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMakerFullAccess_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMaker-ExecutionRole-20230916T105234_AmazonSageMakerFullAccess.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsApiGatewayRole_AmazonSageMakerServiceCatalogProductsApiGatewayServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsApiGatewayRole_AmazonSageMakerServiceCatalogProductsApiGatewayServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsCloudformationRole_AmazonSageMakerServiceCatalogProductsCloudformationServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsCloudformationRole_AmazonSageMakerServiceCatalogProductsCloudformationServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsCodeBuildRole_AmazonSageMakerServiceCatalogProductsCodeBuildServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsCodeBuildRole_AmazonSageMakerServiceCatalogProductsCodeBuildServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsCodePipelineRole_AmazonSageMakerServiceCatalogProductsCodePipelineServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsCodePipelineRole_AmazonSageMakerServiceCatalogProductsCodePipelineServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsEventsRole_AmazonSageMakerServiceCatalogProductsEventsServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsEventsRole_AmazonSageMakerServiceCatalogProductsEventsServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsExecutionRole_AmazonSageMakerFullAccess_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsExecutionRole_AmazonSageMakerFullAccess.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsFirehoseRole_AmazonSageMakerServiceCatalogProductsFirehoseServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsFirehoseRole_AmazonSageMakerServiceCatalogProductsFirehoseServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsGlueRole_AmazonSageMakerServiceCatalogProductsGlueServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsGlueRole_AmazonSageMakerServiceCatalogProductsGlueServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsLambdaRole_AmazonSageMakerServiceCatalogProductsLambdaServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsLambdaRole_AmazonSageMakerServiceCatalogProductsLambdaServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsLaunchRole_AmazonSageMakerAdmin-ServiceCatalogProductsServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsLaunchRole_AmazonSageMakerAdmin-ServiceCatalogProductsServiceRolePolicy.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsUseRole_AmazonS3FullAccess_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsUseRole_AmazonS3FullAccess.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSageMakerServiceCatalogProductsUseRole_AmazonSageMakerServiceCatalogProductsUseRole-20230916T105295_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AmazonSageMakerServiceCatalogProductsUseRole_AmazonSageMakerServiceCatalogProductsUseRole-20230916T105295.id}"
}

output "aws_iam_role_policy_attachment_tfer--AmazonSagemakerCanvasForecastRole-20230916T105232_AmazonSageMakerCanvasForecastAccess_id" {
...
output "aws_iam_role_policy_attachment_tfer--StepFunctions-MyStateMachine-w9dekhf9k-role-p2qhxfjbm_S3ListBucketScopedAccessPerBucketPolicy-80b6ba5c-189e-4a51-8e06-bcd981c7cdf4_id" {
  value = "${aws_iam_role_policy_attachment.tfer--StepFunctions-MyStateMachine-w9dekhf9k-role-p2qhxfjbm_S3ListBucketScopedAccessPerBucketPolicy-80b6ba5c-189e-4a51-8e06-bcd981c7cdf4.id}"
}

output "aws_iam_role_policy_attachment_tfer--StepFunctions-MyStateMachine-w9dekhf9k-role-p2qhxfjbm_StepFunctionsStartExecutionManagementScopedAccessPolicy-03cdcf15-3121-48e4-ba91-a84d2c0ebe62_id" {
  value = "${aws_iam_role_policy_attachment.tfer--StepFunctions-MyStateMachine-w9dekhf9k-role-p2qhxfjbm_StepFunctionsStartExecutionManagementScopedAccessPolicy-03cdcf15-3121-48e4-ba91-a84d2c0ebe62.id}"
}

output "aws_iam_role_policy_attachment_tfer--StepFunctions-MyStateMachine-w9dekhf9k-role-p2qhxfjbm_XRayAccessPolicy-169f2389-3183-4b01-be7f-2234ce0879ae_id" {
...
output "aws_iam_role_tfer--AmazonSageMaker-ExecutionRole-20230916T105234_id" {
  value = "${aws_iam_role.tfer--AmazonSageMaker-ExecutionRole-20230916T105234.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsApiGatewayRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsApiGatewayRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsCloudformationRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsCloudformationRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsCodeBuildRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsCodeBuildRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsCodePipelineRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsCodePipelineRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsEventsRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsEventsRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsExecutionRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsExecutionRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsFirehoseRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsFirehoseRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsGlueRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsGlueRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsLambdaRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsLambdaRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsLaunchRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsLaunchRole.id}"
}

output "aws_iam_role_tfer--AmazonSageMakerServiceCatalogProductsUseRole_id" {
  value = "${aws_iam_role.tfer--AmazonSageMakerServiceCatalogProductsUseRole.id}"
}

output "aws_iam_role_tfer--AmazonSagemakerCanvasForecastRole-20230916T105232_id" {
...
output "aws_iam_role_tfer--twentyfour-hour-video-python-IamRoleCustomResources_id" {
  value = "${aws_iam_role.tfer--twentyfour-hour-video-python-IamRoleCustomResources.id}"
}
...
output "aws_iam_user_policy_attachment_tfer--thom_AWSBudgetsActionsWithAWSResourceControlAccess_id" {
  value = "${aws_iam_user_policy_attachment.tfer--thom_AWSBudgetsActionsWithAWSResourceControlAccess.id}"
}

output "aws_iam_user_policy_attachment_tfer--thom_AWSBudgetsActions_RolePolicyForResourceAdministrationWithSSM_id" {
  value = "${aws_iam_user_policy_attachment.tfer--thom_AWSBudgetsActions_RolePolicyForResourceAdministrationWithSSM.id}"
}
...
output "aws_iam_user_policy_attachment_tfer--thom_AWSCostAndUsageReportAutomationPolicy_id" {
  value = "${aws_iam_user_policy_attachment.tfer--thom_AWSCostAndUsageReportAutomationPolicy.id}"
}
