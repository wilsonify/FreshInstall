...
resource "aws_s3_bucket_policy" "tfer--sagemaker-studio-eo1ez6iuugp" {
  bucket = "sagemaker-studio-eo1ez6iuugp"
  policy = "{\"Id\":\"Enforce HTTPS\",\"Statement\":[{\"Action\":\"s3:*\",\"Condition\":{\"Bool\":{\"aws:SecureTransport\":\"false\"}},\"Effect\":\"Deny\",\"Principal\":\"*\",\"Resource\":\"arn:aws:s3:::sagemaker-studio-eo1ez6iuugp\"}],\"Version\":\"2008-10-17\"}"
}
